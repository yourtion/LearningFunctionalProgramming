(ns com.yourtion.Pattern14.discount-example)
...
(defn run []
  (println "Discount : ")
  (println "calculate-discount : " (calculate-discount bill))
  (println "calculate-discount-namedfn : " (calculate-discount-namedfn bill))
  (println ""))
